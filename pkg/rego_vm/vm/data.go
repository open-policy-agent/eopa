...
type (
	...
	DataOperations vm.DataOperations
	...
	CallNamespace interface {
		Call(ctx context.Context, args []*interface{}, caller *vm.State) (interface{}, bool, bool, error)
	}
)

func NewDataOperations() DataOperations {
	return &operations{}
}

func (*operations) Get(ctx context.Context, value, key interface{}) (interface{}, bool, error) {
...
func (*operations) GetCall(ctx context.Context, value, key interface{}) (interface{}, bool, error) {
	jkey, err := castJSON(ctx, key)
	if err != nil {
		return nil, false, err
	}
...
func (*operations) IsCall(value interface{}) (bool, error) {
	switch value.(type) {
	case CallNamespace:
		return true, nil
	default:
...
func (*operations) Call(ctx context.Context, value interface{}, args []*interface{}, caller *vm.State) (interface{}, bool, bool, error) {
	switch v := value.(type) {
	case CallNamespace:
...
func (*operations) ArrayAppend(ctx context.Context, array interface{}, value interface{}) (interface{}, error) {
...
func (*operations) CopyShallow(value interface{}) interface{} {
	switch v := value.(type) {
	case fjson.Null:
		return v
	case fjson.Bool:
...
func (*operations) Equal(ctx context.Context, a, b interface{}) (bool, error) {
...
func (o *operations) FromInterface(x interface{}) interface{} {
	switch x := x.(type) {
	case nil:
...
func (o *operations) Iter(ctx context.Context, v interface{}, f func(key, value interface{}) bool) error {
	switch v := v.(type) {
	case fjson.Array:
		n := v.Len()
		for i := 0; i < n; i++ {
...
func (*operations) IsArray(ctx context.Context, v interface{}) (bool, error) {
	switch v.(type) {
	case fjson.Array:
		return true, nil
	case IterNamespace:
...
func (*operations) IsObject(ctx context.Context, v interface{}) (bool, error) {
	switch v.(type) {
...
func (*operations) MakeArray(capacity int32) interface{} {
	return fjson.NewArray()
}

func (*operations) MakeBoolean(v bool) interface{} {
	return fjson.NewBool(v)
}

func (*operations) MakeObject() interface{} {
	return NewObject()
}

func (*operations) MakeNull() interface{} {
	return fjson.NewNull()
}

func (*operations) MakeNumberFloat(f float64) interface{} {
	return fjson.NewFloat(gojson.Number(strconv.FormatFloat(f, 'g', -1, 64)))
}

func (*operations) MakeNumberInt(i int64) interface{} {
	return fjson.NewFloat(gojson.Number(strconv.FormatInt(i, 10)))
}

func (*operations) MakeNumberRef(n interface{}) interface{} {
	return fjson.NewFloat(gojson.Number(n.(fjson.String).Value()))
}

func (*operations) MakeSet() interface{} {
	return NewSet()
}

func (*operations) MakeString(v string) interface{} {
	return fjson.NewString(v)
}

func (o *operations) Len(ctx context.Context, v interface{}) (interface{}, error) {
	switch v := v.(type) {
	case fjson.Array:
...
func (*operations) ObjectGet(ctx context.Context, object, key interface{}) (interface{}, bool, error) {
...
func (*operations) ObjectInsert(ctx context.Context, object, key, value interface{}) error {
...
func (o *operations) ObjectMerge(a, b interface{}) (interface{}, error) {
...
func (*operations) SetAdd(ctx context.Context, set, value interface{}) error {
	jvalue, err := castJSON(ctx, value)
	if err != nil {
		return err
	}
...
func (o *operations) ToAST(ctx context.Context, v interface{}) (ast.Value, error) {
	switch v := v.(type) {
	case fjson.Null:
		return ast.Null{}, nil
...
func (o *operations) ToInterface(ctx context.Context, v interface{}) (interface{}, error) {
	v, err := o.ToAST(ctx, v)
	if err != nil {
		return nil, err
	}
...
func equal(a, b fjson.Json) bool {
	...
	case fjson.Array:
		if y, ok := b.(fjson.Array); ok {
			...
			for i := 0; i < x.Len(); i++ {
				if !equal(x.Iterate(i), y.Iterate(i)) {
					return false
				}
			}

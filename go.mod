...
require (
	...
	github.com/open-policy-agent/opa-envoy-plugin v1.3.0-envoy-1
...
replace github.com/open-policy-agent/opa => github.com/StyraInc/opa v1.2.1-0.20250403092203-bc2f5d0ee762

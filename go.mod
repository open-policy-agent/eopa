...
require (
	...
	github.com/open-policy-agent/opa-envoy-plugin v1.5.1-envoy
...
replace github.com/open-policy-agent/opa => github.com/StyraInc/opa v1.4.1-0.20250611215720-17a0f5a4c70d

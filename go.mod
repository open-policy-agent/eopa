...
require (
	...
	github.com/benthosdev/benthos/v4 v4.18.0
	...
	github.com/keygen-sh/keygen-go/v2 v2.6.1
	...
	github.com/testcontainers/testcontainers-go/modules/vault v0.23.0
...
replace github.com/open-policy-agent/opa => github.com/StyraInc/opa v0.55.1-0.20230728193905-281608a741c3

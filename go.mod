...
// These are transitive dependencies of vault's tests. We don't run those tests.
// The original depends on an outdated version of the Azure SDK that kept blocking
// us from upgrading Benthos.
replace github.com/hashicorp/vault-plugin-auth-azure => ./build/replacements/github.com/hashicorp/vault-plugin-auth-azure

replace github.com/hashicorp/vault-plugin-secrets-azure => ./build/replacements/github.com/hashicorp/vault-plugin-secrets-azure
...
replace github.com/open-policy-agent/opa => github.com/StyraInc/opa v0.52.1-0.20230501161531-e38b5b8205e5

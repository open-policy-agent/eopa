...
require (
	...
	github.com/testcontainers/testcontainers-go/modules/neo4j v0.26.0 // indirect
...
replace github.com/open-policy-agent/opa => github.com/StyraInc/opa v0.57.1-0.20231103165051-04ecd53346b7

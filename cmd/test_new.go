...
`,
		...
		Args: func(_ *cobra.Command, args []string) error {
			...
			if _, err := os.Stat("new"); !errors.Is(err, fs.ErrNotExist) {
				return fmt.Errorf("Name collision between 'eopa test' and 'eopa test new' commands detected. No tests will be run or generated.") // nolint:staticcheck
			}

...
var file_eopa_bulk_v1_bulk_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0xbc, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x6f, 0x70,
	...
	,
...
var file_eopa_bulk_v1_bulk_proto_goTypes = []interface{}{
...
func file_eopa_bulk_v1_bulk_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eopa_bulk_v1_bulk_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eopa_bulk_v1_bulk_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eopa_bulk_v1_bulk_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eopa_bulk_v1_bulk_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eopa_bulk_v1_bulk_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eopa_bulk_v1_bulk_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eopa_bulk_v1_bulk_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eopa_bulk_v1_bulk_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eopa_bulk_v1_bulk_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eopa_bulk_v1_bulk_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eopa_bulk_v1_bulk_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
	...
	file_eopa_bulk_v1_bulk_proto_msgTypes[3].OneofWrappers = []interface{}{
	...
	file_eopa_bulk_v1_bulk_proto_msgTypes[4].OneofWrappers = []interface{}{
	...
	file_eopa_bulk_v1_bulk_proto_msgTypes[7].OneofWrappers = []interface{}{
	...
	file_eopa_bulk_v1_bulk_proto_msgTypes[8].OneofWrappers = []interface{}{

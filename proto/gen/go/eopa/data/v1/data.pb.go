...
func (m *StreamingDataRWRequest_WriteRequest) GetReq() isStreamingDataRWRequest_WriteRequest_Req {
	if m != nil {
		return m.Req
	}
	return nil
...
func (x *StreamingDataRWRequest_WriteRequest) GetCreate() *CreateDataRequest {
	if x, ok := x.GetReq().(*StreamingDataRWRequest_WriteRequest_Create); ok {
		return x.Create
	}
	return nil
}
...
func (x *StreamingDataRWRequest_WriteRequest) GetUpdate() *UpdateDataRequest {
	if x, ok := x.GetReq().(*StreamingDataRWRequest_WriteRequest_Update); ok {
		return x.Update
	}
	return nil
}
...
func (x *StreamingDataRWRequest_WriteRequest) GetDelete() *DeleteDataRequest {
	if x, ok := x.GetReq().(*StreamingDataRWRequest_WriteRequest_Delete); ok {
		return x.Delete
	}
	return nil
}
...
func (m *StreamingDataRWResponse_WriteResponse) GetResp() isStreamingDataRWResponse_WriteResponse_Resp {
	if m != nil {
		return m.Resp
	}
	return nil
...
func (x *StreamingDataRWResponse_WriteResponse) GetCreate() *CreateDataResponse {
	if x, ok := x.GetResp().(*StreamingDataRWResponse_WriteResponse_Create); ok {
		return x.Create
	}
	return nil
}
...
func (x *StreamingDataRWResponse_WriteResponse) GetUpdate() *UpdateDataResponse {
	if x, ok := x.GetResp().(*StreamingDataRWResponse_WriteResponse_Update); ok {
		return x.Update
	}
	return nil
}
...
func (x *StreamingDataRWResponse_WriteResponse) GetDelete() *DeleteDataResponse {
	if x, ok := x.GetResp().(*StreamingDataRWResponse_WriteResponse_Delete); ok {
		return x.Delete
	}
	return nil
}
...
var file_eopa_data_v1_data_proto_rawDesc = []byte{
	...
	,
...
func file_eopa_data_v1_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_eopa_data_v1_data_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingDataRWRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eopa_data_v1_data_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingDataRWResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eopa_data_v1_data_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eopa_data_v1_data_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingDataRWRequest_WriteRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eopa_data_v1_data_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingDataRWRequest_ReadRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eopa_data_v1_data_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingDataRWResponse_WriteResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_eopa_data_v1_data_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingDataRWResponse_ReadResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_eopa_data_v1_data_proto_msgTypes[13].OneofWrappers = []interface{}{
	...
	file_eopa_data_v1_data_proto_msgTypes[15].OneofWrappers = []interface{}{

...
[![OPA v1.12.1](https://openpolicyagent.org/badge/v1.12.1)](https://github.com/open-policy-agent/opa/releases/tag/v1.12.1)
[![Regal v0.37.0](https://img.shields.io/github/v/release/open-policy-agent/regal?filter=v0.37.0&label=Regal)](https://github.com/open-policy-agent/regal/releases/tag/v0.37.0)

This release pulls in [OPA v1.12.1](https://github.com/open-policy-agent/opa/releases/tag/v1.12.1) and the latest Regal release, [v0.37.0](https://github.com/open-policy-agent/regal/releases/tag/v0.37.0).


## v1.45.1

[![OPA v1.10.1](https://openpolicyagent.org/badge/v1.10.1)](https://github.com/open-policy-agent/opa/releases/tag/v1.10.1)
...
This release pulls in [OPA v1.10.1](https://github.com/open-policy-agent/opa/releases/tag/v1.10.1).
...
This release includes only a release engineering bugfix for the build system, with no other code changes from the EOPA [v1.43.0 release](https://github.com/open-policy-agent/eopa/releases/tag/v1.43.0).
...
This release pulls in [OPA v1.8.0](https://github.com/open-policy-agent/opa/releases/tag/v1.8.0).

Until the binary signing setup is restored, we'll go with only publishing docker images (https://ghcr.io/open-policy-agent/eopa) and binaries in the GitHub release artifacts.
Homebrew and properly-signed artifacts for macOS and Windows will come back in the future.
...
This release includes various dependency bumps, and updates the embedded OPA version to [v1.5.0](https://github.com/open-policy-agent/opa/releases/tag/v1.5.0).
...
This release includes various dependency bumps, and updates the embedded OPA version to [v1.3.0](https://github.com/open-policy-agent/opa/releases/tag/v1.3.0),
and the embedded Regal version to [v0.32.0](https://github.com/StyraInc/regal/releases/tag/v0.32.0).
...
This release includes an [SQLite](https://www.sqlite.org/) target for data filters generated by the [Compile API](https://docs.styra.com/enterprise-opa/reference/api-reference/partial-evaluation-api), along with bugfixes and dependency bumps.

This release also includes **[Windows Authenticode](https://learn.microsoft.com/en-us/windows/win32/seccrypto/time-stamping-authenticode-signatures) signing and timestamping** for the Windows EOPA binary.
...
This release includes a bug fix for ref heads and an overeager planner optimization (see [upstream issue](https://github.com/open-policy-agent/opa/issues/7399) and [fix](https://github.com/open-policy-agent/opa/pull/7439)).
It also features performance improvements to the [gRPC API plugin](https://docs.styra.com/enterprise-opa/tutorials/integrating/go-grpc).
...
This release brings in the latest OPA version, [v1.2.0](https://github.com/open-policy-agent/opa/releases/tag/v1.2.0),
updates the embedded Regal version to [v0.31.1](https://github.com/StyraInc/regal/releases/tag/v0.31.1),
and includes various other dependency bumps.
...
This release brings in the latest OPA version, [v1.1.0](https://github.com/open-policy-agent/opa/releases/tag/v1.1.0),
and various dependency bumps.
...
It also pulls in the latest Regal version, [v0.30.2](https://github.com/StyraInc/regal/releases/tag/v0.30.2).
...
This release includes another bugfix for Enterprise OPA's [bundle](https://www.openpolicyagent.org/docs/latest/management-bundles/) handling, allowing it to make use of the `rego_version` bundle manifest field.

This release also bumps the embedded Regal version to [v0.30.0](https://github.com/StyraInc/regal/releases/tag/v0.30.0).
...
This release includes a bugfix for Enterprise OPA's [bundle](https://www.openpolicyagent.org/docs/latest/management-bundles/) handling, restoring compatibility with v0 policy bundles.
...
[![OPA v0.70.0](https://img.shields.io/endpoint?url=https://openpolicyagent.org/badge-endpoint/v0.70.0)](https://github.com/open-policy-agent/opa/releases/tag/v0.70.0)
[![Regal v0.28.0](https://img.shields.io/github/v/release/styrainc/regal?filter=v0.28.0&label=Regal)](https://github.com/StyraInc/regal/releases/tag/v0.28.0)
...
This release includes various dependency bumps, and updates the embedded OPA version to [v0.70.0](https://github.com/open-policy-agent/opa/releases/tag/v0.70.0).
...
For all configuration options, please see [the reference documentation](https://docs.styra.com/enterprise-opa/reference/configuration/decision-logs/gcs).
